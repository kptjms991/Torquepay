...
export default function AdminTransactionsPage() {
  ...
  const handleExport = () => {
    const csv = [
      ['Transaction ID', 'Date', 'Amount', 'Currency', 'Type', 'Status', 'User ID', 'Description'],
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-50">
      ...
      <div className="bg-white border-b border-gray-200 shadow-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <h1 className="text-2xl font-bold text-[#006a4e]">Transaction Monitor</h1>
          <p className="text-sm text-gray-600 mt-1">Real-time platform transaction monitoring</p>
        </div>
      </div>
              ...
              <Table>
                <TableHeader className="bg-gray-50">
                  <TableRow>
                    ...
                    <TableHead className="text-[#006a4e] font-semibold">User</TableHead>
                    <TableHead className="text-[#006a4e] font-semibold">Currency</TableHead>
                  </TableRow>
                </TableHeader>
                <TableBody>
                  {filteredTransactions.map((tx) => (
                    <TableRow key={tx.id} className="hover:bg-gray-50 transition">
                      ...
                      <TableCell className="font-mono text-xs text-gray-600">{tx.user_id.slice(0, 8)}...</TableCell>
                      <TableCell className="text-sm text-gray-700">{tx.currency}</TableCell>
                    </TableRow>
                  ))}
                </TableBody>
              </Table>
